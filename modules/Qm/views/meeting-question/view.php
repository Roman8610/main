...
/**
 * @var app\modules\Qm\models\MeetingQuestion $question
...
use app\modules\Qm\widgets\CommentsWidget;
...
<div class="question-content">
    ...
    <div class="question-meta-panel">
        <div class="panel-header">
            <h1><?= $question->name ?></h1>
            <div>
                <?php if (Yii::$app->getModule('Qm')->get('meetingQuestionAccessService')->canUpdate($question->id, Yii::$app->user->id)): ?>
                    <?= Html::a('Редактирование', ['meeting-question/update', 'id' => $question->id], [
                        'class' => 'btn btn-primary btn-sm',
                        'title' => 'Редактирование',
                    ]); ?>
                <?php endif; ?>
                <?php if (Yii::$app->getModule('Qm')->get('meetingQuestionAccessService')->canDelete($question->id, Yii::$app->user->id)): ?>
                    ...
                    ?>
                <?php endif; ?>
                <?php if (Yii::$app->getModule('Qm')->get('meetingQuestionAccessService')->canMakeModeration($question->id, Yii::$app->user->id)): ?>
                    ...
                    ?>
                <?php endif ?>
                <?php if (Yii::$app->getModule('Qm')->get('meetingQuestionAccessService')->canMakeOff($question->id, Yii::$app->user->id)): ?>
    ...
    <?php $form = ActiveForm::begin([
        'action' => ['/Qm/question-comments/create', 'id' => $question->id],
    ]); ?>
    <?= $form->field($formModelCommentCreate, 'text')->textarea(['rows' => 6]); ?>
    <?php if (!Yii::$app->getModule('Qm')->get('meetingQuestionAccessService')->canCreateCommentToQuestion($question->id, Yii::$app->user->id)): ?>
